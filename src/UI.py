...
class UI(QDialog):
    def __init__(self):
        ...
        with self.lock:
            ...
            self.bottom_right_buttons_layout = QHBoxLayout()
            self.bottom_right_buttons_layout.addWidget(self.edit_params_button)
            self.bottom_right_buttons_layout.addWidget(self.exit_button)
            ...
            self.right_col_layout.addLayout(self.bottom_right_buttons_layout)
